package es.nullbyte.squishedforge.impl.dump;

import com.mojang.serialization.Codec;
import com.mojang.serialization.DataResult;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import es.nullbyte.squishedforge.impl.Dimension;
import es.nullbyte.squishedforge.impl.mixin.MultiNoiseBiomeSourceAccessor;
...
public class BiomeDumper {
    ...
    public static final String[] EXAMPLES = Arrays.stream(es.nullbyte.squishedforge.impl.Dimension.values()).map(v -> v.name().toLowerCase(Locale.ROOT)).toArray(String[]::new);
